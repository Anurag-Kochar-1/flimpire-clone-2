    ...
    <>
      ...
      {showModal ? (
        <>
          ...
          >
            {/* <div className="bg-green-400 relative w-[100%] my-6 mx-auto"> */}
            <div className="relative w-[100%] my-6 flex justify-center">
              {/*content*/}
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-[80%] bg-red-400 outline-none focus:outline-none">
                {/*header*/}

                <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                  <h3 className="text-3xl font-semibold">
                    {movieORtv === 'movie' ? modalData?.title : modalData?.name }
                  </h3>
                  <button
                ...
                <div className="relative p-6 flex justify-center w-[100%] bg-indigo-300">
